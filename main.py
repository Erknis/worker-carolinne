...
TEST_LINK = os.getenv("TEST_LINK", "https://sstv.center/chatbot/98d64bd0-1b1d-4343-9896-a635bbd600f5")
PAYMENT_SITE_URL = os.getenv("PAYMENT_SITE_URL", "")
PIX_KEY = os.getenv("PIX_KEY", "03186401046")

app = FastAPI(title="Carolinne Worker", version="1.0.0")
...
def reply_for(req: EvolutionInbound) -> WorkerReply:
    ...
    if intent == "pagamento_internacional":
        if PAYMENT_SITE_URL:
            ...
            return WorkerReply(intent=intent, reply_text=msg)
